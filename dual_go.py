...
#    RoseServer's self.channel is now self.channels
#
...
SHOW_TIME = 60  # Time of shows in seconds
...
class RoseServer(object):
    ...
    def _create_services(self):
        ...
        self.runner = ShowRunner(self.rose_model,
                                 self.rose_simulator,
                                 args.max_time,
                                 self.rose_simulator.get_channel())
    ...
    def stop(self):
        if self.running:  # should be safe to call multiple times
            try:
                ...
                print ("Exception stopping Roses! {}".format(e))
                traceback.print_exc()
