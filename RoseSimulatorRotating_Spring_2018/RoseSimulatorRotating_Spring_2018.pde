...
short[][][] curr_buffer = new short[numBigRose][NUM_PIXELS][3];
short[][][] next_buffer = new short[numBigRose][NUM_PIXELS][3];
short[][][] morph_buffer = new short[numBigRose][NUM_PIXELS][3];
...
void processPixelCommand(String cmd) {
  ...
  sendColorOut(rose, pix, (short)r, (short)g, (short)b, false);  
...
void sendColorOut(byte rose, int pix, short r, short g, short b, boolean morph) {
...
void morph_frame(float fract) {
  ...
  for (byte rose = 0; rose < numBigRose; rose++) {
    for (int pix = 0; pix < NUM_PIXELS; pix++) {
      r1 = curr_buffer[rose][pix][0];
      g1 = curr_buffer[rose][pix][1];
      b1 = curr_buffer[rose][pix][2];
      
      r2 = next_buffer[rose][pix][0];
      g2 = next_buffer[rose][pix][1];
      b2 = next_buffer[rose][pix][2];
...
void setPixelBuffer(byte BigRose, int pixel, short r, short g, short b, boolean morph) {
